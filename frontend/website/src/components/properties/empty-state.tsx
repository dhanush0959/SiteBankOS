...
export function PropertiesEmptyState() {
  return (
    <div className="rounded-2xl border-2 border-dashed border-border/40 bg-gradient-to-br from-amber-500/[0.04] via-transparent to-amber-400/[0.04] p-12 text-center">
      {/* Icon */}
      <div className="relative w-20 h-20 mx-auto">
        <div className="relative w-20 h-20 rounded-2xl bg-primary text-primary-foreground flex items-center justify-center ring-1 ring-foreground/10">
