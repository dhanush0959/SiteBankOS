import type { PropertyType, TransactionType, PropertyStatus, VerificationStatus, MediaType, DocumentVisibility } from './enums';
...
export interface PublicProperty extends Omit<Property, 'internalNotes' | 'documents'> {
    documents?: Array<Omit<PropertyDocument, 'fileUrl'> & {
        signedUrl?: string;
    }>;
}
